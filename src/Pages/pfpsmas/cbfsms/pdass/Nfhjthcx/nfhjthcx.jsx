...
class Nfhjthcx extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            visible: 'none',//家庭户
                            ...
                            <div
                                ...
                                <Tabs defaultActiveKey="1" className="ssiraTabs">
                                    <TabPane tab="父亲信息" key="1">
                                        ...
                                        <div className="margin-top-20 white-line">
                                        ...
                                        <Row>
                                            ...
                                            <Col span={2} offset={1}>
                                                <Button type="primary" onClick={this.handleFatherPush.bind(this)} >推送</Button>
                                            </Col>
                                        </Row>
                                    </TabPane>
                                    <TabPane tab="母亲信息" key="2">
                                        ...
                                        <Row>
                                            ...
                                            <Col span={2} offset={1}>
                                                <Button type="primary" onClick={this.handleMotherPush.bind(this)} >推送</Button>
                                            </Col>
                                        </Row>
                                    </TabPane>
...
Nfhjthcx = Form.create()(Nfhjthcx);
export default Nfhjthcx;